...
export default function Page() {
  ...
  return (
    <main className="h-full flex flex-col justify-center items-center p-12 mt-24 mb-24">
          <h1 className="mb-7 text-3xl font-bold">Sign Up</h1>
          <form className="flex flex-col space-y-2 text-md md:w-1/3 w-full" ref={form}>
              ...
              <label>
                  <input required type="number" placeholder="Phone Number" className="w-full bg-black rounded-md text-white p-2" name="phone"/>
              </label>
              <label>
                  <input required type="password" placeholder="Password" className="w-full bg-black rounded-md text-white p-2" name="password"/>
              </label>
              <label>
                  <input required type="password" placeholder="Confirm Password" className="w-full bg-black rounded-md text-white p-2" name="confirm"/>
              </label>
